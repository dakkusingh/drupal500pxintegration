...
(function ($, Drupal, drupalSettings, CKEDITOR) {
  ...
  CKEDITOR.plugins.add('d500px_add_photo', {
    icons: 'd500px_add_photo',
    hidpi: true,

    init: function (editor) {
      // Add the commands for add.photo
      editor.addCommand('d500px_add_photo', {
        ...
        exec: function (editor) {
          ...
          Drupal.ckeditor.openDialog(editor, Drupal.url('d500px-wysiwyg/dialog/' + editor.config.drupal.format), existingValues, saveCallback, dialogSettings);
        }
      });

      // Add buttons for link.
